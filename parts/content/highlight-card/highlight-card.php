...
$modifier .= ( isset($data['image_vertical_position']) ) ? ' has-image-position-'. $data['image_vertical_position'] : ''; ?>
...
<?php if ( $data['image']!='' && $data['heading']!='' ): ?>
	<article class="highlight-card <?= $modifier; ?>">
		<figure class="highlight-card__media-wrap">
			...
			<?php if ( $data['badge']!='' ){ ?>
				<figcaption class="highlight-card__media-caption"><?= $data['badge']; ?></figcaption>
			<?php } ?>
