...
// Term
	...
	} else if ( $current_term->taxonomy=='event_category' ){
...
// Archive
	...
	if ( $current_cpt->name=='event' ){
		$background_color = 'pink';
	} else if ( $current_cpt->name=='exhibition' ){
		$background_color = 'lemon';
		$title = 'What\'s Inside';
...
$modifier .= ( $text_column_1!='' || $text_column_2!=''  ) ? ' has-text' : '';
...
<header class="section-hero <?= $modifier; ?>">
