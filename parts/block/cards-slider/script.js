...
(function (){
	...
	document.addEventListener('DOMContentLoaded', function () {
		if ( document.querySelectorAll('.block-cards-slider.splide').length>0 ) {
			document.querySelectorAll('.block-cards-slider.splide').forEach(function (item) {
				let perPage = ( item.dataset.perpage ) ? item.dataset.perpage : 3;
				let args = {
					gap: '2.5rem',
					pagination: false,
					perPage: perPage,
